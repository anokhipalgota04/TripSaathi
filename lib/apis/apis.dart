...
class APIs {
  ...
  static Future<bool> userExists() async {
    return (await firestore.collection('chat').doc(user.uid).get()).exists;
  }
  ...
  static Future<void> updateUserInfo() async {
    await firestore.collection('chat').doc(user.uid).update({
      'name': me.name,
      'about': me.about,
    });
  }
  ...
  static Future<void> updateActiveStatus(bool isOnline) async {
    firestore.collection('chat').doc(user.uid).update({
      'is_online': isOnline,
