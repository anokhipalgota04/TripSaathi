...
import 'package:gonomad/features/auth/screen/home_feed/personal_feed.dart'; // Import the personal feed screen
          ...
          appBar: AppBar(
            leading: IconButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => PersonalFeed()),
                );
              },
            ),
            title: _isSearching
          ...
          body: TabBarView(
            ...
            children: [
              ...
              ListView(
                children: [
                  ListTile(
                    leading: Icon(Icons.add), // Icon for Create Group option
