...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  //       //     .collection('cposts')
  //       //     .doc(widget.uid)
  //       //     .update(updatedCpostData);

  //       // Update username in 'cposts' collection if username changed
  //       if (isNameChanged) {
  //         final cpostDocSnapshot = await FirebaseFirestore.instance
  //             .collection('cposts')
  //             .doc(widget.uid)
  //             .get();

  //         if (cpostDocSnapshot.exists) {
  //           print('Document exists in cposts collection');
  //           await FirebaseFirestore.instance
  //               .collection('cposts')
  //               .doc(widget.uid)
  //               .set(updatedCpostData);
  //         } else {
  //           print('Document does not exist in cposts collection');
  //         }
  //       }
    ...
    try {
      ...
      if (isNameChanged || isBioChanged || isProfilePictureChanged) {
        ...
        if (isNameChanged) {
          ...
          if (cpostDocSnapshot.exists) {
            print('Document exists in cposts collection');
            // Set the entire document data with updated username
            await FirebaseFirestore.instance
                .collection('cposts')
                .doc('widget.uid')
                .set(updatedCpostData);
